    ...
    <section id="quiz" className="py-20 bg-brand-blue text-white relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 relative z-10">
        <div className="text-center mb-10">
          <span className="inline-block px-3 py-1 bg-brand-orange text-brand-blue font-display font-extrabold text-xs uppercase tracking-wider rounded-md mb-3">
            Интерактивный опрос
          </span>
                ...
                <div className="bg-brand-light rounded-lg p-6 max-w-xl mx-auto border border-gray-200">
                  ...
                  <div className="flex gap-4 justify-center items-center">
                    <a
                      ...
                      className="w-12 h-12 rounded-full bg-[#25d366] hover:bg-[#22c35e] text-white flex items-center justify-center shadow-md transition-all hover:scale-110 select-none cursor-pointer"
                      title="WhatsApp"
                    >
                ...
                <div className="mt-8">
                  <button
                    ...
                    onClick={() => {
                      ...
                      setHasStarted(false);
                      setFormValues({ name: "", phone: "", email: "", contactMethod: "WhatsApp" });
                    }}
