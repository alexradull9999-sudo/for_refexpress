          ...
          <div className="md:col-span-4 space-y-4.5">
            ...
            <div className="space-y-3.5 text-sm">
              ...
              >
                ...
                <span className="font-mono font-black text-brand-blue text-base hover:text-brand-orange transition">+7 (921) 393-77-05</span>
              </a>
          ...
          <div className="md:col-span-3 space-y-4.5">
            ...
            <div className="flex items-center gap-3">
              ...
              <a
                ...
                title="Написать в WhatsApp (+7 921 355 0263)"
              >
              ...
              {/* МАКС (max.ru) */}
              <a
                href="https://max.ru/u/f9LHodD0cOJrLBPOfliyQPaZAoKmDkBy9y7SHN5pNzwVU7ugpWpU1J952_Q"
                target="_blank"
                rel="noopener noreferrer"
                onClick={handleSocialClick}
                className="w-10 h-10 rounded-full bg-gradient-to-tr from-[#24A1DE] to-[#8E24C2] hover:brightness-110 flex items-center justify-center text-white transition-all hover:scale-110 shrink-0 shadow-sm"
