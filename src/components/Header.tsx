...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md text-brand-dark shadow-sm border-b border-gray-100">
      <div className="max-w-7xl mx-auto px-4 py-3.5 md:py-4.5 flex items-center justify-between">
        {/* LOGO */}
        ...
        <div className="flex items-center gap-4 md:gap-6">
          <div className="hidden sm:flex flex-col text-right">
            ...
            <span className="text-[10px] text-brand-grey">
              Санкт-Петербург • с 8:00 до 21:00 ежедневно
            </span>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <a
              ...
              className="w-8 h-8 rounded-full bg-green-500 hover:bg-green-600 flex items-center justify-center transition-transform hover:scale-105 active:scale-95"
